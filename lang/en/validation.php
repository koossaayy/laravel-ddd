...
return [
    ...
    */
    ...
    'extensions' => ':attributeフィールドには、次のいずれかの拡張子が必要です：:values。',
    'file' => ':attributeフィールドはファイルである必要があります。',
    'filled' => ':attributeフィールドには値が必要です。',
    'gt' => [
        'array' => ':attributeフィールドには:value個より多くの項目が必要です。',
    ...
    'in_array' => ':attributeフィールドは:other内に存在する必要があります。',
    'in_array_keys' => ':attributeフィールドには、次のキーのうち少なくとも1つを含める必要があります：:values。',
    ...
    'lt' => [
        'array' => ':attributeフィールドには:value個未満の項目が必要です。',
    ...
    'lte' => [
        'array' => ':attributeフィールドには:value個を超える項目を含めることはできません。',
    ...
    'missing_if' => ':attributeフィールドは、:otherが:valueの場合、存在してはいけません。',
    'missing_unless' => ':attributeフィールドは、:otherが:valueでない限り、存在してはいけません。',
    'missing_with' => ':attributeフィールドは、:valuesが存在する場合、存在してはいけません。',
    'missing_with_all' => ':attributeフィールドは、:valuesが存在する場合、存在してはいけません。',
